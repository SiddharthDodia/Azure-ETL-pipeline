...
- **Data Ingestion:** Data is ingested daily from the [Earthquake Catalog API](https://www.fdsn.org/webservices/) using **Databricks**.
...
This project utilizes earthquake data from the **Earthquake Catalog API** based on the [FDSN Event Web Service Specification](https://www.fdsn.org/webservices/FDSN-Event-1.2.pdf). 🌍📊🌀
